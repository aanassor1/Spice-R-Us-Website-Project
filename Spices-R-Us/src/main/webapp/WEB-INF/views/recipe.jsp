...
<html lang="en">
  <head>
    ...
    <title>Spices-R-Us | Recipe</title>
  </head>
      ...
      <body>
        ...
        <div class="container" style="--container-gap: 100rem; margin-top: 3rem">
          ...
          <div class="products-heading">
            <h1 class="fs-500 text-black">RECIPES</h1>
            <p class="fs-400 text-black">
              Explore a wide range of recipes, for all styles of cooking...
            </p>
          </div>
          <!-- Recipe listing -->
          <div class="products-container flex" style="margin-top: 2rem" id="content">
            <c:forEach items="${spiceRecipe}" var="recipe">
              <figure class="x">
              <img class="xyz" src="${recipe.getImage()}" alt="${recipe.getName()}" width="349" height="349">
                <figcaption>
                <h1 style="text-align: center">${recipe.getName()}</h1><br>
                <p style ="text-align: center;">${recipe.getSpiceDescription()}</p><br>
                <p style="text-align: center">${recipe.getDescription()}</p><br>
                </figcaption>
                <div class = "read-more">
                <button onclick="location.href = '/recipe/instruction?id=${recipe.getId()}';">Read more...</button>
                </div>
            </figure>
            </c:forEach>
